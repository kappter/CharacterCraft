const tabs = document.querySelectorAll('nav a');
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const handleClick = (e) => {
            ...
            if (tagName === 'BUTTON' && dataset.tab) {
                ...
                const bio = document.querySelector('#bioPreview')?.innerText || generateDetailedBio({
                ...
                document.querySelector('#selectedTraits').innerHTML = `Trait: ${e.target.textContent}`;
            ...
            } else if (id === 'generateAutobiography' && window.utils && window.utils.generateAutobiography) {
    ...
    function resetApp() {
        if (!isRandomizing) {
            ...
            document.querySelector('#bioPreview').innerHTML = '';
